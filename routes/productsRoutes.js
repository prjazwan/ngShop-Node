...
router.get('/', async (req, res) => {
    ...
    // console.log(req.query); -> { categories: '5f15d54cf3a046427a1c26e3,5f15d467f3a046427a1c26e1' }
    let filter = {};
    if (req.query.categories)
        filter = { category: req.query.categories.split(',') };
        // console.log(filter) {category: [ '5f15d54cf3a046427a1c26e3', '5f15d467f3a046427a1c26e1' ]}
